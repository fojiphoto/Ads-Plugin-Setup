...
public class Ads : MonoBehaviour
{
...
#if UNITY_ANDROID
    [Header("Banner ID")]
    public string bannerId = "ca-app-pub-3940256099942544/6300978111";//test banner ads id

    [Header("MREC ID")]
    public string bannerMRECId = "ca-app-pub-3940256099942544/6300978111";//test banner ads id

    [Header("Interstitial ID")]
    public string interId = "ca-app-pub-3940256099942544/1033173712";//test interstitial id
    ...
    public void LoadMrec()
    {
        ...
        print("Loading banner Ad !!");
        mrecView.LoadAd(adRequest);//show the banner on the screen
    }
    void CreateMRECView()
    {
        ...
        mrecView = new BannerView(bannerMRECId, AdSize.MediumRectangle, AdPosition.BottomRight);
    }
    void ListenToMRECEvents()
    {
        mrecView.OnBannerAdLoaded += () =>
        {
            Debug.Log("Banner view loaded an ad with response : "
                + mrecView.GetResponseInfo());
        };
        // Raised when an ad fails to load into the banner view.
        ...
        // Raised when an ad opened full screen content.
        mrecView.OnAdFullScreenContentOpened += () =>
        {
            Debug.Log("Banner view full screen content opened.");
        };
        // Raised when the ad closed full screen content.
        mrecView.OnAdFullScreenContentClosed += () =>
        {
            Debug.Log("Banner view full screen content closed.");
        };
    }
    public void DestroyMRECAd()
    {
    ...
    public void ShowRewardedAd(Action Rewarded)
    {
        RewardedAction = Rewarded;
    ...
    public void ShowRewardeVideo() 
    {
        ShowRewardedAd(ShowCoins);
    }
